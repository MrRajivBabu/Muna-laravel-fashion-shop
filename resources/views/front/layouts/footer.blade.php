...
<div class="footer footer-2">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 about-us-col">
                    ...
                    <p><i class="anm anm-map-marker-al" aria-hidden="true"></i> 55 Gallaxy Enque, 2568 steet,
                        23568 NY</p>
                    <p><i class="anm anm-phone-l" aria-hidden="true"></i> +880 1408451436</p>
                    <p><i class="anm anm-envelope-l" aria-hidden="true"></i> <a
                            href="mailto:sales@yousite.com">sales@munafashion.com</a></p>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-bottom clearfix">
        <div class="container">
            <div class="copytext">
                &copy; Muna Fashion Shop - All Rights Reserved.
            </div>
        </div>
    </div>
</div>
...
<div id="quickView-modal" class="mfp-with-anim mfp-hide">
    ...
    <div class="row">
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item carousel-item active" data-slide-number="0">
                            <img data-src="{{ asset('front-assets/images/product-images/product2.jpg') }}"
                                src="{{ asset('front-assets/images/product-images/product2.jpg') }}" alt="" title="">
                        </div>
                        <!-- End slide 1 -->
                        <!-- slide 2 -->
                        <div class="item carousel-item" data-slide-number="1">
                            <img data-src="{{ asset('front-assets/images/product-images/product2-1.jpg') }}"
                                src="{{ asset('front-assets/images/product-images/product2-1.jpg') }}" alt="" title="">
                        </div>
                        <!-- End slide 3 -->
                        <!-- slide 2 -->
                        <div class="item carousel-item" data-slide-number="2">
                            <img data-src="{{ asset('front-assets/images/product-images/product2-2.jpg') }}"
                                src="{{ asset('front-assets/images/product-images/product2-2.jpg') }}" alt="" title="">
                        </div>
                        <!-- End slide 3 -->
                        <!-- slide 4 -->
                        <div class="item carousel-item" data-slide-number="3">
                            <img data-src="{{ asset('front-assets/images/product-images/product2-3.jpg') }}"
                                src="{{ asset('front-assets/images/product-images/product2-3.jpg') }}" alt="" title="">
                        </div>
                        <!-- End slide 4 -->
                        <!-- slide 5 -->
                        <div class="item carousel-item" data-slide-number="4">
                            <img data-src="{{ asset('front-assets/images/product-images/product2-4.jpg') }}"
                                src="{{ asset('front-assets/images/product-images/product2-4.jpg') }}" alt="" title="">
                        </div>
                        <!-- End slide 4 -->
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="sort-description">Avone Multipurpose Bootstrap 4 Html Template that will give you and
                your customers a smooth shopping experience which can be used for various kinds of stores such
                as fashion.. </div>
