        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-8 col-sm-8 col-md-4 col-lg-4 text-left d-none d-sm-none d-md-none d-lg-block">
                    <a href="tel:440011104420833"><i class="anm anm-phone-l"></i> +880 1408451436</a>
                    <a href="mailto:sales@yourstorename.com"><i class="anm anm-envelope-l"></i>
                        sales@munafashion.com</a>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 text-center d-xs-block d-sm-block d-lg-block">
                    Welcome to Muna Fashion (15% discount on every item).
                </div>
...
<header class="header animated d-flex align-items-center header-2">
    <div class="container-fluid">
        <div class="row">
            <!--Mobile Icons-->
            ...
            <div class="logo col-4 col-sm-4 col-md-4 col-lg-1 align-self-center">
                <a href="index-2.html">
                    <img src="{{ asset('front-assets/images/muna.png') }}" alt="Avone Multipurpose Html Template"
            ...
            <div class="col-1 col-sm-1 col-md-1 col-lg-9 align-self-center d-menu-col">
                ...
                <nav class="grid__item" id="AccessibleNav">
                    <ul id="siteNav" class="site-nav medium left hidearrow">
                        ...
                        <li class="lvl1 parent megamenu"><a href="#">Categories <i class="fa fa-caret-down"></i></a>
                                        ...
                                        <ul class="grid">
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2"><a href="product-external-affiliate.html"
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <div class="menu-brand-logo">
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo1.png') }}"
                                                            alt="" /></a>
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo2.png') }}"
                                                            alt="" /></a>
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo3.png') }}"
                                                            alt="" /></a>
                                                </div>
                                                <div class="menu-brand-logo">
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo4.png') }}"
                                                            alt="" /></a>
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo5.png') }}"
                                                            alt="" /></a>
                                                    <a href="#;"><img src="{{ asset('front-assets/images/logo/brandlogo6.png') }}"
                                                            alt="" /></a>
                                                </div>
                                            </li>
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3 p-0">
                                                <a href="#"><img src="{{ asset('front-assets/images/megamenu-banner3.jpg') }}" alt="" /></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Blog</a></li>
                ...
                <div id="settingsBox">
                    <div class="customer-links">
                        ...
                        <p class="text-center">New User? <a href="register.html" class="register">Create an
                                Account</a></p>
                        <p class="text-center">welcome to muna!</p>
                    </div>
                </div>
        ...
        <li class="lvl1 parent megamenu"><a href="index-2.html">Home <i class="anm anm-plus-l"></i></a>
            <ul>
                <li><a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="index-2.html" class="site-nav">Home 01 <span
                ...
                <li>
                    ...
                    <ul>
                        <li class="lvl-2"><a href="index-jewelry-store.html" class="site-nav">Jewelry Store</a>
                        </li>
                        ...
                        <li class="lvl-2"><a href="index-digital-store.html" class="site-nav">Digital Store</a>
                        </li>
                        ...
                        <li class="lvl-2"><a href="index-kids-toy.html" class="site-nav lvl-2">Kids Toy <span
                                    class="lbl nm_label2">New</span></a></li>
                    </ul>
                </li>
            </ul>
